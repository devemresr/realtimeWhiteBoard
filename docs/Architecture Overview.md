...
![End-to-End Flow](./diagrams/UMLSequenceDiagram.drawio.svg)
...
| Load balancing      | nginx                | Round-robin for all tiers, sticky sessions not required due to Socket.IO Redis adapter              |
